...
adstock_model <- new("AdstockModel", data = input_data, dates = input_dates, 
                     saturation_models = list("linear", "diminishing", "log", "exponential"),
                     distribution_params = input_dist_params)
